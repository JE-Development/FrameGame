<template>
  ...
  <div class="center-horizontal">
    <div>
      ...
      <PublicRoom v-for="(dat) in rooms" :hoster="dat.hoster" :playerCount="dat.playerCount" :rc="dat.rc"
        @clicked="clicked" />
    </div>
  </div>
...
export default {
  ...
  name: "PublicPage",
  components: { PublicRoom, PlayerView, BackgroundView, Toast },
  data() {
    return {
      rooms: [],
      socket: null,
  ...
  mounted() {
    ...
    this.socket.addEventListener('message', (event) => {
      ...
      } else if (message.func === "usernameExist") {
        this.unableMessage = this.lang.register.usernameExist
        this.displayToast()
      }
